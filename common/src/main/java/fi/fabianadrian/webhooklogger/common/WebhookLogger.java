...
import fi.fabianadrian.webhooklogger.common.webhook.WebhookManagerImpl;
...
public final class WebhookLogger {
	...
	private final WebhookManagerImpl webhookManager;
	...
	public WebhookLogger(Platform platform) {
		...
		this.webhookManager = new WebhookManagerImpl(this);
	}
